...
def serve(
    ...
    num_devices: Optional[int] = typer.Option(
        torch.cuda.device_count(), "--num-devices", help="The number of devices to serve the model on"
    ),
    ...
    Arguments:
    model: module path of the model, in the format of module.submodule:ModelClassName
    ...
    log_level (Optional[str]): The log level to serve the model on. Defaults to "INFO".
    """
